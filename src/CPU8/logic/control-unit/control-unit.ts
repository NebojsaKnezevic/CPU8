...
export class ControlUnit {
    ...
    private testRegAInput: Bit = 0; //FOR TEST ONLY SET 1
    private testRegBInput: Bit = 0; //FOR TEST ONLY SET 1

    public setTestRegInputsFrom3x8Decoder(a: Bit, b: Bit) {
        this.testRegAInput = a;
        this.testRegBInput = b;
    }
    ...
    setInputs(clockInput: [Bit, Bit, Bit]) {
        ...
        // console.log(this.R[0].getData())
        // console.log(this.R[1].getData())
        // console.log(this.R[2].getData())
        // console.log(this.R[3].getData())
        // console.log(this.decoder67s_2x4_b.getOutput())
        // console.log(this.decoder45e_2x4_a.getOutput())
        ...
        //####### ENABLE
        this.enableRegisters([b4, b5, b6, b7], clke, out5, out4);
        this.enableBus1([s1]);
        this.enableIAR([s1], clke);
        this.enableRAM([s2], clke);
        this.enableACC([s3, out6], clke);

        //####### SET
        this.setRegisters([b6, b7], clks, out6);
        this.setMAR([s1], clks);
    ...
    private enableRegisters(inputs: [Bit, Bit, Bit, Bit], clke: Bit, regA: Bit, regB: Bit) {
    ...
    private setRegisters(inputs: [Bit, Bit], clks: Bit, regB: Bit) {
        const [b6, b7] = inputs;
    ...
    private enableRAM(inputs: Bit[], clke: Bit) {
        this.controlLogicCore.ram_OrmGate.setInputs(inputs);
        this.controlLogicCore.ram_andGateE.setInputs(this.controlLogicCore.ram_OrmGate.getOutput(), clke);
